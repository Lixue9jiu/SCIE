...
namespace Game
{
	public class SubsystemPresserNBlockBehavior : SubsystemBlockBehavior
	{
		...
		{
			DatabaseObject databaseObject = SubsystemTerrain.Project.GameDatabase.Database.FindDatabaseObject("PresserN", SubsystemTerrain.Project.GameDatabase.EntityTemplateType, true);
