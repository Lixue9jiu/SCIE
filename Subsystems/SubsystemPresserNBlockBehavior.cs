...
namespace Game
{
	public class SubsystemPresserNBlockBehavior : SubsystemBlockBehavior
	{
		...
		{
			DatabaseObject databaseObject = base.SubsystemTerrain.Project.GameDatabase.Database.FindDatabaseObject("PresserN", base.SubsystemTerrain.Project.GameDatabase.EntityTemplateType, true);
		...
		public override bool OnInteract(TerrainRaycastResult raycastResult, ComponentMiner componentMiner)
		{
			...
			ComponentPresserN componentFurnace = blockEntity.Entity.FindComponent<ComponentPresserN>(true);
			componentMiner.ComponentPlayer.ComponentGui.ModalPanelWidget = new PresserNWidget(componentMiner.Inventory, componentFurnace);
