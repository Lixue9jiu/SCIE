...
namespace Game
{
	public class SubsystemCReactorBlockBehavior : SubsystemBlockBehavior
	{
		...
		public override void OnBlockAdded(int value, int oldValue, int x, int y, int z)
		{
			...
			valuesDictionary.PopulateFromDatabaseObject(Project.GameDatabase.Database.FindDatabaseObject("CReactor", Project.GameDatabase.EntityTemplateType, true));
