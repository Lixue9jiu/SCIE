...
namespace Game
{
	public class SubsystemPresserBlockBehavior : SubsystemBlockBehavior
	{
		...
		public override void OnBlockAdded(int value, int oldValue, int x, int y, int z)
		{
			...
			valuesDictionary.PopulateFromDatabaseObject(Project.GameDatabase.Database.FindDatabaseObject("Presser", Project.GameDatabase.EntityTemplateType, true));
		...
		public override bool OnInteract(TerrainRaycastResult raycastResult, ComponentMiner componentMiner)
		{
			...
			ComponentPresser componentFurnace = blockEntity.Entity.FindComponent<ComponentPresser>(true);
			componentMiner.ComponentPlayer.ComponentGui.ModalPanelWidget = new PresserWidget(componentMiner.Inventory, componentFurnace);
