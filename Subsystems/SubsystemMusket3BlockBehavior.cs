...
namespace Game
{
	public class SubsystemMusket3BlockBehavior : SubsystemMusket2BlockBehavior
	{
		...
		{
			return value != Terrain.MakeBlockValue(214, 0, Bullet2Block.SetBulletType(0, Bullet2Block.BulletType.HandBullet)) || Musket3Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex))) > 62
				? 0
				: 1;
		}
