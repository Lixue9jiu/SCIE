...
namespace Game
{
	public class SubsystemEngineBlockBehavior : SubsystemBlockBehavior
	{
		...
		public override void OnBlockAdded(int value, int oldValue, int x, int y, int z)
		{
			...
			{
				DatabaseObject databaseObject = SubsystemTerrain.Project.GameDatabase.Database.FindDatabaseObject("SteamEngine", SubsystemTerrain.Project.GameDatabase.EntityTemplateType, true);
