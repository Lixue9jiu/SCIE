...
namespace Game
{
	public class SubsystemPresserNNBlockBehavior : SubsystemBlockBehavior
	{
		...
		{
			DatabaseObject databaseObject = base.SubsystemTerrain.Project.GameDatabase.Database.FindDatabaseObject("PresserNN", base.SubsystemTerrain.Project.GameDatabase.EntityTemplateType, true);
