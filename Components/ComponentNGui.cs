...
namespace Game
{
	public class ComponentNGui : ComponentGui, IUpdateable
	{
		...
		public static Widget OpenEntity(IInventory inventory, Entity entity)
		{
			...
			var componentEngine51 = entity.FindComponent<ComponentChest>();
			...
			var componentEngine7 = entity.FindComponent<ComponentEngineT4>();
			if (componentEngine7 != null)
				return new EngineTWidget(inventory, componentEngine7, "Widgets/PaviorWidget");
