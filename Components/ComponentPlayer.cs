...
namespace Game
{
	public class ComponentNPlayer : ComponentPlayer, IUpdateable
	{
		public new void Update(float dt)
		{
			...
			float num2 = (m_subsystemGameInfo.WorldSettings.GameMode == GameMode.Creative || block.BlockIndex == Musket2Block.Index || block.BlockIndex == Musket3Block.Index || block.BlockIndex == Musket4Block.Index) ? 0.1f : 1.4f;
