...
namespace Game
{
	public class ComponentNPlayer : ComponentPlayer, IUpdateable
	{
		public new void Update(float dt)
		{
			...
			//	if ((readOnlyList.Count > 0 && ClothingBlock.GetClothingData(Terrain.ExtractData(readOnlyList[readOnlyList.Count - 1])).DisplayName == Utils.Get("Ç±Ë®Í·¿ø")) || (ComponentBody.ImmersionFluidBlock != null && ComponentBody.ImmersionFluidBlock.BlockIndex == RottenMeatBlock.Index))
			//	{
