...
namespace Game
{
	...
	public class IEBatteryBlock : FlatBlock, IDurability
	{
		...
		public override void Initialize()
		{
			...
			m_standaloneBlockMesh3.AppendMesh("Models/Saw", "Saw", Matrix.CreateRotationX(1.6f) * Matrix.CreateRotationY(1.6f)* Matrix.CreateRotationY(0.8f) * Matrix.CreateRotationZ(0.8f) * Matrix.CreateTranslation(0.3f, -0.5f, 0.5f) * Matrix.CreateScale(.75f), Matrix.CreateTranslation(12f / 16f, -1f / 16f, 0f) * Matrix.CreateScale(50f), Color.White);
