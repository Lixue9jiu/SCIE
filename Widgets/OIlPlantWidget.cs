...
namespace Game
{
	public class OilPlantWidget : CanvasWidget
	{
		...
		public OilPlantWidget(IInventory inventory, ComponentMachine componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/OilPlantWidget"));
