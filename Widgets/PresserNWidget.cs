...
namespace Game
{
	public class PresserNWidget : CanvasWidget
	{
		protected readonly ComponentPresserN m_componentFurnace;
		...
		public PresserNWidget(IInventory inventory, ComponentPresserN componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/PresserNWidget"));
