...
namespace Game
{
	public class ElectricIFurnaceWidget : CanvasWidget
	{
		protected readonly ComponentElectricIFurnace m_componentFurnace;
		...
		public ElectricIFurnaceWidget(IInventory inventory, ComponentElectricIFurnace componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/ElectricIFurnaceWidget"));
