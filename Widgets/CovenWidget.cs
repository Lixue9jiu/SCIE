...
namespace Game
{
	...
	{
		public CovenWidget(IInventory inventory, ComponentCoven componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/CovenWidget"));
		...
		protected readonly ComponentCoven m_componentFurnace;
