...
namespace Game
{
	public class SeperatorWidget : CanvasWidget
	{
        ...
        public SeperatorWidget(IInventory inventory, ComponentSeperator componentFurnace)
		{
            ...
            m_cir1 = Children.Find<InventorySlotWidget>("CircuitSlot1", true);
            m_cir2 = Children.Find<InventorySlotWidget>("CircuitSlot2", true);
