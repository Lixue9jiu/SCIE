...
namespace Game
{
	...
	{
		protected readonly ComponentSqueezer m_componentFurnace;
		...
		public SqueezerWidget(IInventory inventory, ComponentSqueezer componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/SqueezerWidget"));
