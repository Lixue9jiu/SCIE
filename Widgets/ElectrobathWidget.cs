...
namespace Game
{
	public class ElectrobathWidget : CanvasWidget
	{
		...
		public ElectrobathWidget(IInventory inventory, ComponentMachine componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/ElectrobathWidget"));
