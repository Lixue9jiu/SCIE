...
namespace Game
{
	public class MagnetizerWidget : CanvasWidget
	{
		protected readonly ComponentMagnetizer m_componentFurnace;
		...
		public MagnetizerWidget(IInventory inventory, ComponentMagnetizer componentFurnace)
		{
			m_componentFurnace = componentFurnace;
			WidgetsManager.LoadWidgetContents(this, this, ContentManager.Get<XElement>("Widgets/MagnetizerWidget"));
