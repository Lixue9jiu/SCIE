...
namespace Game
{
	public partial class ItemBlock : CubeBlock, IItemBlock
	{
		public static Item[] Items = new Item[]
		{
			...
			new MetalLine(MetalType.Silver),
			...
			new MetalIngot(MetalType.Silver),
			...
			new OrePowder(MetalType.Silver),
			...
			new Rod("silver", new Color(253, 253, 253)),
